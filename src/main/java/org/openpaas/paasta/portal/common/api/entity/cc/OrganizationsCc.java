...
public class OrganizationsCc {
    ...
    public int getSpaceCountTOL() {
        return spaceCountTOL;
    }

    public void setSpaceCountTOL(int spaceCountTOL) {
        this.spaceCountTOL = spaceCountTOL;
    }

    public int getApplicationCountTOL() {
        return applicationCountTOL;
    }

    public void setApplicationCountTOL(int applicationCountTOL) {
        this.applicationCountTOL = applicationCountTOL;
    }

    public int getUserCountTOL() {
        return userCountTOL;
    }

    public void setUserCountTOL(int userCountTOL) {
        this.userCountTOL = userCountTOL;
    }
}
